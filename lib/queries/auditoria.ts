...
export const ROTULO_EVENTO: Record<string, string> = {
  ...
  'impressao.pre_conta': 'Imprimiu pré-conta',
  'impressao.cozinha_por_funcao_ligada': 'Ligou a cozinha roteada pela função',
  'impressao.cozinha_por_funcao_desligada': 'Desligou a cozinha roteada pela função',
